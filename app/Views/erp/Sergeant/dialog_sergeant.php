...
<?php $attributes = array('name' => 'edit_sergeant', 'id' => 'edit_sergeant', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
<?php $hidden = array('_method' => 'EDIT', 'token' => $field_id);?>
<?= form_open('erp/sergeant/update_sergeant', $attributes, $hidden);?>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="sergeant_name" placeholder="<?= lang('Dashboard.left_sergeant_name');?>" value="<?= $result['sergeant_name'];?>">
      </div>
      <div class="form-group">
...
$(document).ready(function(){
	...
	/* Edit data */
	$("#edit_sergeant").submit(function(e){
	e.preventDefault();
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?= site_url("erp/sergeant/sergeant_list") ?>",
							type : 'GET'
						},
						"language": {

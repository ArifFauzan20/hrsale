...
//$(document).ready(function(){
	...
	{ id: "", class: "role-checkbox-modal custom-control-input input-light-primary", text: "<?= lang('Dashboard.left_sergeant');?>", value: "sergeant1", check: "<?php if(isset($role_id)) { if(in_array('sergeant1',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
	{ id: "", class: "role-checkbox-modal custom-control-input input-light-primary", text: "<?= lang('Main.xin_role_enable');?>", value: "sergeant1", check: "<?php if(isset($role_id)) { if(in_array('sergeant1',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",},
	{ id: "", class: "role-checkbox-modal custom-control-input input-light-primary", text: "<?= lang('Main.xin_add');?>", value: "sergeant2", check: "<?php if(isset($role_id)) { if(in_array('sergeant2',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",},
	{ id: "", class: "role-checkbox-modal custom-control-input input-light-primary", text: "<?= lang('Main.xin_edit');?>", value: "sergeant3", check: "<?php if(isset($role_id)) { if(in_array('sergeant3',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",},
	{ id: "", class: "role-checkbox-modal custom-control-input input-light-primary", text: "<?= lang('Main.xin_delete');?>", value: "sergeant4", check: "<?php if(isset($role_id)) { if(in_array('sergeant4',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",},
	]},
